...
public class EventButton : ButtonToggleBase
{
    ...
    {
        //GameObject objectname = GameObject.Find("GameObjectName");    //ex:GameObject camera = GameObject.Find("Main Camera");   tag the object that script under's
        //ScriptName script = objectname.GetComponent<ScriptName>();    //ex: TimerAndPause timer = camera.GetComponent<TimerAndPause>();
        //script.BoolTypeValuable = Button_Value;                       //ex:timer.pauseGame=Button_Value;
    }
