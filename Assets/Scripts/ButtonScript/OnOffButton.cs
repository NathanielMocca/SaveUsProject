...
public class OnOffButton : ButtonToggleBase
{
    ...
    {
        GameObject AEDtext = GameObject.Find("OnOffText");
        AEDOnOff text = AEDtext.GetComponent<AEDOnOff>();
        text.OnOff = Button_Value;
    }
